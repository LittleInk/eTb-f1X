...
public class KillAura extends Module {
    ...
    private BooleanValue criticals = new BooleanValue("Criticals", false);
	...
	public void onUpdate(UpdateEvent event) {
	    ...
	    if ((!mc.thePlayer.isEntityAlive() || (mc.currentScreen != null && mc.currentScreen instanceof GuiGameOver)) || mc.thePlayer.ticksExisted <= 1) {
			this.toggle();
    ...
    private void attack(final EntityLivingBase target, boolean crit) {
        ...
        if (crit && canCrit()) {
            ...
            double[] d = {0.0001,0.0000000114514,0.00000000054876,0.0};
            for(double i:d) {
            	mc.thePlayer.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(x, y + i, z, false));
            }
